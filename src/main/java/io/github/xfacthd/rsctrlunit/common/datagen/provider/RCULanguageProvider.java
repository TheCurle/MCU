...
public final class RCULanguageProvider extends LanguageProvider
{
    ...
    private void addScreenTranslations()
    {
        ...
        add(ControllerScreen.TITLE_NO_PROCESSOR, "Insert a processor");

        add(I8051Screen.TAB_TITLE_STATUS, "Status");
        add(I8051Screen.TAB_TITLE_CODE, "Code");
        add(I8051Screen.TAB_TITLE_REDSTONE, "Redstone");
        add(I8051Screen.TABLE_HEADER_PORT, "Port");
        add(I8051Screen.TABLE_HEADER_SIDE, "Side");
        add(I8051Screen.TABLE_HEADER_TYPE, "Type");
        add(I8051Screen.TABLE_HEADER_DIRECTION, "Direction");
        add(I8051Screen.TABLE_HEADER_MAPPING, "Mapping");
        add(I8051Screen.TITLE_REGISTERS, "Registers");
        add(I8051Screen.TITLE_DISASSEMBLY, "Disassembly");
        add(I8051Screen.BUTTON_LOAD_ROM, "Load ROM from card");
        add(I8051Screen.BUTTON_SAVE_ROM, "Save ROM to card");
        add(I8051Screen.BUTTON_CLEAR_ROM, "Clear ROM");
        add(I8051Screen.BUTTON_PAUSE, "Pause");
        add(I8051Screen.BUTTON_RESUME, "Resume");
        add(I8051Screen.BUTTON_STEP, "Step");
        add(I8051Screen.BUTTON_RESET, "Reset");
        add(I8051Screen.BUTTON_EDIT_PORT_MAP, "Edit port mapping");
        add(I8051Screen.BUTTON_SHOW_PORT_MAP, "Show port mapping");
        add(I8051Screen.BUTTON_HIDE_PORT_MAP, "Hide port mapping");
        add(I8051Screen.LABEL_PROGRAM_KEY, "Program: %s");
        add(I8051Screen.LABEL_PORT_REG_OUT, "Out");
        add(I8051Screen.LABEL_PORT_REG_IN, "In");
        add(I8051Screen.TOOLTIP_RUNNING, "Interpreter is running");
        add(I8051Screen.TOOLTIP_PAUSED, "Interpreter is paused");

        add(ControllerScreen.BUTTON_INSERT_PROCESSOR, "Insert Processor");
