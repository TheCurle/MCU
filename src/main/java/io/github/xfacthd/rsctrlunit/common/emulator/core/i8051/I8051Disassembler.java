...
public class I8051Disassembler extends Disassembler {

    public I8051Disassembler() { super(); }

    public Disassembly disassemble(@Nullable Code code)
    {
    ...
    private static String printRegisterIndirect(I8051Opcode opcode)
    {
        return (opcode.ordinal() & 0x1) != 0 ? "@R1" : "@R0";
    }

    private static String printRegisterDirect(I8051Opcode opcode)
    {
